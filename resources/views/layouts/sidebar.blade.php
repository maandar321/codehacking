    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{{asset('asset/img/avatar3.png')}}" class="img-circle" alt="User Image" />
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{url('admin/users')}}"><i class="badge pull-right bg-green"></i> All user</a></li>
                    <li><a href="{{url('admin/users/create')}}"><i class="badge pull-right bg-green"></i> Create user</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
